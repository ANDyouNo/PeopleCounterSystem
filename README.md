...
появлении людей. Он контролирует связь с программой ПК по UDP-heartbeat:
при потере heartbeat звучит предупреждение раз в 3 секунды, а второй LED
мигает красным. При низком заряде (< 3.50 В для Li-ion 1S) первый LED
горит красным и предупреждение повторяется раз в 10 минут.
...
связь с ПК и присутствие людей. Яркость ограничена 50 % в прошивке.
